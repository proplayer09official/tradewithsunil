...
fbq('init', '903848381863384');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=903848381863384&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
</head>
...
<body>
    <div class="hero">
        ...
        <div class="mgbt button1">
            <a href="https://telegram.me/+Fbn1U0EFWCo5Y2Jl" target="_blank" class="back pd">JOIN NOW FOR FREE <i
        ...
        <br />
        <div class="button1">
            <a href="https://telegram.me/+Fbn1U0EFWCo5Y2Jl" target="_blank" class="back pd">SUBSCRIBE FOR FREE <i
                    class="fa-brands fa-telegram" aria-hidden="true"></i></a>
        </div>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
